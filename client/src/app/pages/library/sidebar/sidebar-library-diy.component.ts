...
import { BehaviorSubject, combineLatest, filter, map, pipe, switchMap, take } from "rxjs";
...
@Component({
  selector: "app-sidebar-library-diy",
  templateUrl: "sidebar-library-diy.component.html",
  styleUrls: ["sidebar-library.component.css"],
  encapsulation: ViewEncapsulation.None,
})
export class SidebarLibraryDiyComponent implements OnInit {
  data: Data = {};
  flatData: FlatNode[] = [];
  routePath = "";
  routeArtist = "";
